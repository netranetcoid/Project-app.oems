...
<aside id="layout-menu" class="layout-menu menu-vertical menu"
  ...
  <div class="osm-company-context menu-text">
    ...
    <span>
      ...
      <strong>{{ session('company_name') ?: config('variables.companyLegalName') }}</strong>
    </span>
  </div>
