...
<div class="card mb-4" id="mobile-branding">
  ...
  <div class="card-body">
    <form method="POST" enctype="multipart/form-data" action="{{ route('ovallhr.control-center.branding.update') }}" class="row g-3">@csrf @method('PUT')
      ...
      <div class="col-md-4"><label class="form-label">Warna navigasi bawah</label><div class="input-group"><input class="form-control form-control-color" type="color" value="{{ old('navigation_color', $branding['navigation_color'] ?? '#1D2B40') }}" oninput="document.getElementById('navigationColor').value=this.value"><input id="navigationColor" class="form-control" name="navigation_color" required pattern="#[0-9A-Fa-f]{6}" value="{{ old('navigation_color', $branding['navigation_color'] ?? '#1D2B40') }}"></div><div class="form-text">Latar Home, Pengajuan, dan Profil.</div></div>
<div class="col-md-4"><label class="form-label">Warna tombol scan Kehadiran</label><div class="input-group"><input class="form-control form-control-color" type="color" value="{{ old('attendance_action_color', $branding['attendance_action_color'] ?? '#06B6D4') }}" oninput="document.getElementById('attendanceActionColor').value=this.value"><input id="attendanceActionColor" class="form-control" name="attendance_action_color" required pattern="#[0-9A-Fa-f]{6}" value="{{ old('attendance_action_color', $branding['attendance_action_color'] ?? '#06B6D4') }}"></div><div class="form-text">Tombol scan tepat di tengah navigasi.</div></div>
<div class="col-md-4"><label class="form-label">Warna kolom Akses Cepat</label><div class="input-group"><input class="form-control form-control-color" type="color" value="{{ old('quick_menu_color', $branding['quick_menu_color'] ?? '#364359') }}" oninput="document.getElementById('quickMenuColor').value=this.value"><input id="quickMenuColor" class="form-control" name="quick_menu_color" required pattern="#[0-9A-Fa-f]{6}" value="{{ old('quick_menu_color', $branding['quick_menu_color'] ?? '#364359') }}"></div><div class="form-text">Kartu fitur agar tampilan tidak monoton.</div></div>
