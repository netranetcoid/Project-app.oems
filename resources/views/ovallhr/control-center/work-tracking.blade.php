...
<script>
  ...
  const resolveAddress = (point) => {
    ...
    slot.textContent = 'Mencari alamat titik iniâ€¦';
  ...
  showDetail = (route, selectedPoint = null) => {
    ...
    detail.insertAdjacentHTML('beforeend', '<div class="tracking-stat"><small class="text-muted d-block">Alamat titik</small><strong data-tracking-address>Memuat alamatâ€¦</strong></div>');
