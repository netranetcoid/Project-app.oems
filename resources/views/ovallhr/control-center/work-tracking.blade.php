...
<div class="card mb-4">
  <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2"><div><h5 class="mb-0">Rute perjalanan</h5><small class="text-muted">Motor biru = posisi terbaru saat masih aktif; abu-abu = posisi terakhir setelah out; kuning = berhenti minimal 10 menit.</small></div><div class="d-flex gap-1"><span class="badge bg-label-info">Aktif</span><span class="badge bg-label-secondary">Sudah out</span><span class="badge bg-label-warning">Berhenti</span><span class="badge bg-label-primary">{{ $date }}</span></div></div>
