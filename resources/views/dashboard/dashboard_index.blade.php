          ...
          <div class="row align-items-center g-4 position-relative">
            <div class="col-lg-8">
              <div class="d-flex align-items-center gap-3 mb-3">
                <img src="{{ asset('assets/img/logo/osm-brand-mark-v2.png') }}" alt="OSM" class="osm-hero-logo">
                <div class="osm-hero-divider d-none d-sm-block"></div>
                <div class="d-none d-sm-block">
                  <div class="osm-hero-eyebrow">Enterprise Management System</div>
                  <div class="osm-hero-company">{{ config('variables.companyLegalName') }}</div>
                </div>
              </div>
              <h2 class="text-white mb-2">Selamat datang, {{ $stats['user_name'] }}</h2>
              ...
              <div class="d-flex flex-wrap gap-2 osm-quick-actions">
                @can('employees.view')<a href="{{ route('employees.index') }}" class="btn btn-sm btn-light"><i class="ri ri-team-line me-1"></i>Pegawai</a>@endcan
                @can('attendance.view')<a href="{{ route('attendance.index') }}" class="btn btn-sm btn-outline-light"><i class="ri ri-fingerprint-line me-1"></i>Absensi</a>@endcan
            ...
            <div class="col-lg-4">
              <div class="osm-active-company-card ms-lg-auto">
                ...
                <strong>{{ $stats['company_name'] }}</strong>
                <div>Company ID {{ $stats['active_company_id'] ?? '-' }}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card-body">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <h6 class="mb-0">{{ $stats['user_name'] }}</h6>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <h6 class="mb-0">{{ $stats['company_name'] }}</h6>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <h6 class="mb-0">{{ $stats['roles']->count() }}</h6>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <h6 class="mb-0">{{ $stats['permissions_count'] }}</h6>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <span class="text-muted">{{ $stats['user_email'] }}</span>
          </div>
          ...
          <div>
            ...
            @forelse ($stats['roles'] as $role)
              <span class="badge bg-label-primary me-1 mb-1">{{ $role }}</span>
            @empty
