...
<div class="row">
  <div class="col-xl-7 mb-4"><div class="card h-100"><div class="card-header"><h5 class="mb-0">Absensi & Privasi</h5></div><div class="card-body row g-3">
    <div class="col-md-6"><label class="form-label">Latitude kantor utama</label><input class="form-control" name="office_latitude" required value="{{ old('office_latitude',$settings['office_latitude'] ?? -6.612755088971767) }}"></div>
    <div class="col-md-6"><label class="form-label">Longitude kantor utama</label><input class="form-control" name="office_longitude" required value="{{ old('office_longitude',$settings['office_longitude'] ?? 106.75548743646192) }}"></div>
    <div class="col-md-6"><label class="form-label">Radius default (meter)</label><input class="form-control" type="number" min="1" max="5000" name="attendance_radius_meter" required value="{{ old('attendance_radius_meter',$company->attendance_radius_meter ?? 150) }}"></div>
