...
class OvertimeAttendanceController extends Controller
{
    ...
    public function checkIn(Request $request)
    {
        ...
        $overtime->fill([
            ...
            'geofence_distance_meters' => $distance, 'geofence_validated' => (bool) $policy['geofence_required'], 'in_photo' => $this->storeProof($request, $employee->company_id, $employee->id, $businessNow, 'in'),
